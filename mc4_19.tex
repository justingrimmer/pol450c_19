...
\only<1>{\scalebox{0.5}{\includegraphics{probit10.pdf}}}
\only<2>{\scalebox{0.5}{\includegraphics{probit100.pdf}}}
\only<3>{\scalebox{0.5}{\includegraphics{probit250.pdf}}}
\only<4>{\scalebox{0.5}{\includegraphics{probit500.pdf}}}
\only<5>{\scalebox{0.5}{\includegraphics{probit1000.pdf}}}
...
\invisible<1-7>{We will perform inference on these next lecture}
